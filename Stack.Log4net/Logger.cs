...
namespace Stack.Log4net
{
    ...
    public class Logger
    {
        ...
        /// </summary>
        /// <param name="message"></param>
        public static void WaLiuBasicInfo(object message)
        {
            Log4Context.WaLiuBasicServiceLog.Info(message);
        }
        ...
        /// </summary>
        /// <param name="message"></param>
        public static void ApiMonitorInfo(object message)
        {
            Log4Context.ApiMonitorLog.Info(message);
        }
